          ...
          <h2 className='text-center text-[20px] uppercase'>subdirección de educación superior de formación profesional <br /> LA PAZ - 2024</h2>
            ...
            <div className='relative flex justify-center' >
                ...
                <button type="button" class={`shadow-2xl ${filter2 === 'Privado' ? 'bg-gradient-to-br text-white  from-purple-600 to-blue-500 hover:bg-gradient-to-bl' : 'border border-[#c6c6c6] text-black '}  focus:outline-none font-medium rounded-lg text-[16px] px-5 py-2.5 text-center me-2 mb-2`} onClick={() => filter2 === 'Privado' ? setFilter2('') : setFilter2('Privado')}>
                  ...
                  <button type="button" class={`shadow-2xl ${filter2 === 'Convenio' ? 'bg-gradient-to-br text-white  from-purple-600 to-blue-500 hover:bg-gradient-to-bl' : 'border border-[#c6c6c6] text-black '}  focus:outline-none font-medium rounded-lg text-[16px] px-5 py-2.5 text-center me-2 mb-2`} onClick={() => filter2 === 'Convenio' ? setFilter2('') : setFilter2('Convenio')}>
